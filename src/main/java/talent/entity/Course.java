...
public class Course {
    ...
    @Id
    @GeneratedValue(generator = "courses_sequence", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "courses_sequence", sequenceName = "courses_id_sequence", allocationSize = 1)
